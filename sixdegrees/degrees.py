...
def shortest_path(source, target):
    ...
    # Initialed the frontier with the source name
    start = Node(state=source, parent=None, action=None)
    frontier = QueueFrontier()
    frontier.add(start)

    # initialize the explored nodes
    explored = set()

    i = 0

    # loop till we find a relationship or no relationship exists
